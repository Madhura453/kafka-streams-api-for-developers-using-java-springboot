...
public class AggregatingStreamPlayGroundApp {
    public static void main(String[] args) {
        ...
        Topology topology = ExploreAggregateOperatorsTopology.buildTopologyByGroupByKey();

       // Topology topology = ExploreAggregateOperatorsTopology.buildTopologyByGroupBy();
