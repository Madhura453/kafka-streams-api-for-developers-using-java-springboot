...
import kafkastreamsbase.ordersdomain.domain.Address;
import kafkastreamsbase.ordersdomain.domain.Store;
        ...
        stores
                .forEach(store -> {
                    try {
                        ...
                        var recordMetaData = publishMessageSync(OrdersTopology.STORES_TOPIC, store.locationId(), storeJSON);
